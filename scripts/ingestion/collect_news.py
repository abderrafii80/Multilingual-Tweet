...
if __name__ == "__main__":
    ...
    fetch_articles(API_KEY, keywords_ar, lang='ar', output_file=os.path.join(base_path, 'articles_ar.json'))
    fetch_articles(API_KEY, keywords_fr, lang='fr', output_file=os.path.join(base_path, 'articles_fr.json'))
    fetch_articles(API_KEY, keywords_en, lang='en', output_file=os.path.join(base_path, 'articles_en.json'))
